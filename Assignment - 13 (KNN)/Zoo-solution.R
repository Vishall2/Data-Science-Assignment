...
Acc3
#for k=10 the Accuracy is 87.18%
...
Acc4
#For k=15 the Accuracy is 84.62%
...
Acc14
#For k=11 the Accuracy is 85.71% Also it has not Classified Type 3 and 5 while Predicting.
