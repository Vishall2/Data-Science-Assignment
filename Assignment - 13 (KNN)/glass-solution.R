...
Accuracy <- round(sum(diag(tab))/sum(tab)*100, digits = 2)
Accuracy
#Accuracy for k=10 is again 57.38
...
Acc2
#For k=5 we got Accuracy as 70.476
...
Acc3
#For k = 6 we got 65.714% Accuracy
...
Acc4
#For k=11 we got Accuracy as 65.714%
...
Acc5
#For k=16, the Accuracy is 64.762%
...
Acc6
#The Accuracy for k=1 is 71.429%
...
Acc7
#For k=21 the Accuracy is 64.762%
