...
ggplot(company) + geom_histogram(aes(Sales),binwidth = 0.5, color = "orange")

ggplot(company) + geom_histogram(aes(CompPrice),binwidth = 10, color = "orange")

ggplot(company) + geom_histogram(aes(Income),binwidth = 1, color = "orange")

ggplot(company) + geom_histogram(aes(Advertising),binwidth = 0.4, color = "orange")

ggplot(company) + geom_histogram(aes(Population),binwidth = 20, color = "orange")

ggplot(company) + geom_histogram(aes(Price),binwidth = 9, color = "orange")

ggplot(company) + geom_histogram(aes(Age),binwidth = 0.7, color = "orange")

ggplot(company) + geom_histogram(aes(Education),binwidth = 0.2, color = "orange")
