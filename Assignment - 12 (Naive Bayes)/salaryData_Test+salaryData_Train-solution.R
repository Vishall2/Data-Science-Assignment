...
plot(area1)
auc1 <- area1$auc
auc1  #Area under the curve: 0.7054
...
plot(area2)
auc1 <- area2$auc
auc1 #Area under the curve: 0.6989
...
plot(area3)
auc3 <- area3$auc
auc3   #Area under the curve: 0.5818
...
plot(area4)
auc4 <- area4$auc
auc4   #Area under the curve: 0.6162
...
plot(area5)
auc5 <- area5$auc
auc5   #Area under the curve: 0.583
...
plot(area6)
auc6 <- area6$auc
auc6     #Area under the curve: 0.5815
...
plot(area7)
auc7 <- area7$auc
auc7   #Area under the curve: 0.5465
