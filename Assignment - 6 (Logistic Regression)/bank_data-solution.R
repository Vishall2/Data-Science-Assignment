...
bank <- read.csv(("D:\\ExcelR\\Assignments\\Assignment - 6 (Logistic Regression)\\bank-full.csv"), sep = ";") #The dta in the file is seperated using Semi-Colons
attach(bank)
summary(bank)
...
accuracy
#The Accuracy of the model we built is 89.27%
