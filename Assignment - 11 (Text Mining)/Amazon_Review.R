...
# Review extraction
url <- "https://www.amazon.in/Test-Exclusive-606/dp/B07HGJK535/ref=sr_1_2?crid=280R8FIQ03WMA&dchild=1&keywords=oneplus+mclaren+7+pro&qid=1617452622&sprefix=oneplus+mac%2Caps%2C274&sr=8-2"
McLaren <- NULL
for(i in 1:10){
