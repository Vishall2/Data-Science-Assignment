...
ggplot(company) + geom_histogram(aes(Sales),binwidth = 0.5, color = "red")

ggplot(company) + geom_histogram(aes(CompPrice),binwidth = 10, color = "red")
...
ggplot(company) + geom_histogram(aes(Population),binwidth = 20, color = "red")

ggplot(company) + geom_histogram(aes(Price),binwidth = 9, color = "red")

ggplot(company) + geom_histogram(aes(Age),binwidth = 0.7, color = "red")

ggplot(company) + geom_histogram(aes(Education),binwidth = 0.2, color = "red")
