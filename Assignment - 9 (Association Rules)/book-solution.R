...
#The Dataset is now Imported as a Data Frame. We will first See the Structure of the Data and make the Necessary Changes and then change it into Transaction
...
itemFrequencyPlot(book2, topN=22)#This will the Plot the Books in Descending Order(order with respect to transaction)
